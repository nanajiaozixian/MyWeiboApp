package com.example.myweiboapp.support.error;
...
public class MyWeiboException extends Exception{
	/**
	...
	private String strOriError;
	private int iErrorCode;
	
	public MyWeiboException(){
		
	}
	public MyWeiboException(String errorMessage){
		strError = errorMessage;
	}
	public MyWeiboException(String errorMessage, Throwable tr){
		strError = errorMessage;
	}
	public String getStrError() {
		...
		if(!TextUtils.isEmpty(strError)){
			...
			String str = "code"+iErrorCode;
			int i = globalContext.getResources().getIdentifier(str, "string", globalContext.getPackageName());
			
			try{
				result = globalContext.getResources().getString(i);
			}catch(Exception NotFoundException){
				if(!TextUtils.isEmpty(strOriError)){
					result = strOriError;
				}else{
					result = globalContext.getResources().getString(R.string.unknown_error_error_code)+iErrorCode;
				}
			}
		}
		return result;
	...
	public String getStrOriError() {
		return strOriError;
	}
	public void setStrOriError(String strOriError) {
		this.strOriError = strOriError;
	}
